  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // TTMCkey...
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (TTMCbase58sig.., Hex, Buffer)
