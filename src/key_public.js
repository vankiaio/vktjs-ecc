...
/**
  ...
  @param {string} [pubkey_prefix = 'TTMC']
*/
function PublicKey(Q, pubkey_prefix = 'TTMC') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'TTMC'] - public key prefix
    */
    function toString(pubkey_prefix = 'TTMC') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'TTMC']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'TTMC') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'TTMC') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'TTMC') {
